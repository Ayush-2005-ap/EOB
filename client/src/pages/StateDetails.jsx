      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="bg-white rounded border border-gray-200 shadow-md p-8 md:p-12 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 pt-8">
            ...
            <div className="bg-[#F5F7FA] rounded p-6 border border-gray-200 flex items-start gap-4 transition-all duration-300 hover:border-[#C8793F] hover:shadow-lg hover:shadow-[#C8793F]/20 hover:-translate-y-1">
